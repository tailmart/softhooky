...
const FALLBACK_NAV_ITEMS: NavItem[] = [
  ...
  { nav_id: 'three-view', label: '三视图生成', category: '素材工作台', enabled: true, sort_order: 3 },
  // 店铺上架素材
  { nav_id: 'detailClone', label: '版式裂变', category: '店铺上架素材', enabled: false, sort_order: 0 },
  { nav_id: 'carousel', label: '独立站轮播图', category: '店铺上架素材', enabled: true, sort_order: 1 },
  { nav_id: 'amazon-carousel', label: '亚马逊轮播图', category: '店铺上架素材', enabled: true, sort_order: 2 },
  ...
  // AI辅助工具
  { nav_id: 'deepseek-chat', label: '电商文案助手', category: 'AI辅助工具', enabled: true, sort_order: 0 },
];
