    ...
    return (
      <div className="px-4 pt-6 pb-6 animate-mobile-fade-in">
        <div className="flex flex-col items-center py-16 mb-6">
          ...
          <p className="text-sm text-gray-400 mb-6">登录后可查看积分和使用记录</p>
          <button
        ...
        <div className="flex items-center justify-center gap-4 pt-4 border-t border-gray-100">
          <button className="text-xs text-gray-300 flex items-center gap-1">
            <FileText size={12} /> 条款
          </button>
          <button className="text-xs text-gray-300 flex items-center gap-1">
            <Shield size={12} /> 隐私
          </button>
          <a href="mailto:softhooky@163.com" className="text-xs text-gray-300 flex items-center gap-1">
            <Mail size={12} /> 联系
          </a>
        </div>
      </div>
      ...
      <div className="mx-4 mt-4 mb-3 rounded-2xl p-5 bg-gradient-to-br from-blue-600/20 to-blue-800/10 border border-blue-500/10">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-[#171717] truncate max-w-[220px]">{user.email}</p>
        ...
        <div className="flex gap-2">
          <button
            ...
            className="mobile-tap flex-1 bg-gray-100 rounded-xl py-3 flex flex-col items-center gap-1 border border-gray-100"
          >
            <CreditCard size={18} className="text-blue-400" />
            <span className="text-[11px] font-medium text-gray-500">充值</span>
          </button>
          <button
          ...
          >
            ...
            <span className="text-[11px] font-medium text-gray-500">图库</span>
          </button>
          <button
          ...
          >
            ...
            <span className="text-[11px] font-medium text-gray-500">记录</span>
          </button>
        </div>
      </div>
          ...
          {menuItems.map((item, idx) => {
            ...
            return (
              <button
                ...
                className={`mobile-tap w-full flex items-center gap-3.5 px-4 py-3.5 ${!isLast ? 'border-b border-gray-100' : ''}`}
              >
